...
var listCodePaysMondeAng = [["Afghanistan","AF"],["Albania","AL"],["Algeria","DZ"],["Andorra","AD"],["Angola","AO"],["Argentina","AR"],["Armenia","AM"],["Australia","AU"],["Austria","AT"],["Azerbaijan","AZ"],["Bahrain","BH"],["Bangladesh","BD"],["Belarus","BY"],["Belgium","BE"],["Belize","BZ"],["Bhutan","BT"],["Bolivia","BO"],["Botswana","BW"],["BouvetIsland","BV"],["Brazil","BR"],["BritishIndianOceanTerritory","IO"],["BritishVirginIslands","VG"],["BruneiDarussalam","BN"],["Bulgaria","BG"],["BurkinaFaso","BF"],["Burundi","BI"],["Cambodia","KH"],["Cameroon","CM"],["Canada","CA"],["CapeVerde","CV"],["CaymanIslands","KY"],["CentralAfricanRepublic","CF"],["Chad","TD"],["Chile","CL"],["China","CN"],["ChristmasIsland","CX"],["Cocos(Keeling)Islands","CC"],["Colombia","CO"],["Comoros","KM"],["Congo(Brazzaville)","CG"],["Congo,DemocraticRepublicofthe","CD"],["CookIslands","CK"],["CostaRica","CR"],["Croatia","HR"],["Cuba","CU"],["Cyprus","CY"],["CzechRepublic","CZ"],["Côted'Ivoire","CI"],["Denmark","DK"],["Djibouti","DJ"],["Dominica","DM"],["DominicanRepublic","DO"],["Ecuador","EC"],["Egypt","EG"],["ElSalvador","SV"],["EquatorialGuinea","GQ"],["Eritrea","ER"],["Estonia","EE"],["Ethiopia","ET"],["FalklandIslands(Malvinas)","FK"],["FaroeIslands","FO"],["Fiji","FJ"],["Finland","FI"],["France","FR"],["FrenchGuiana","GF"],["FrenchPolynesia","PF"],["FrenchSouthernTerritories","TF"],["Gabon","GA"],["Gambia","GM"],["Georgia","GE"],["Germany","DE"],["Ghana","GH"],["Gibraltar","GI"],["Greece","GR"],["Greenland","GL"],["Grenada","GD"],["Guadeloupe","GP"],["Guam","GU"],["Guatemala","GT"],["Guernsey","GG"],["Guinea","GN"],["Guinea-Bissau","GW"],["Guyana","GY"],["Haiti","HT"],["HeardIslandandMcdonaldIslands","HM"],["HolySee(VaticanCityState)","VA"],["Honduras","HN"],["HongKong,SpecialAdministrativeRegionofChina","HK"],["Hungary","HU"],["Iceland","IS"],["India","IN"],["Indonesia","ID"],["Iran,IslamicRepublicof","IR"],["Iraq","IQ"],["Ireland","IE"],["IsleofMan","IM"],["Israel","IL"],["Italy","IT"],["Jamaica","JM"],["Japan","JP"],["Jersey","JE"],["Jordan","JO"],["Kazakhstan","KZ"],["Kenya","KE"],["Kiribati","KI"],["Korea,DemocraticPeople'sRepublicof","KP"],["Korea,Republicof","KR"],["Kuwait","KW"],["Kyrgyzstan","KG"],["LaoPDR","LA"],["Latvia","LV"],["Lebanon","LB"],["Lesotho","LS"],["Liberia","LR"],["Libya","LY"],["Liechtenstein","LI"],["Lithuania","LT"],["Luxembourg","LU"],["Macao,SpecialAdministrativeRegionofChina","MO"],["Macedonia,Republicof","MK"],["Madagascar","MG"],["Malawi","MW"],["Malaysia","MY"],["Maldives","MV"],["Mali","ML"],["Malta","MT"],["MarshallIslands","MH"],["Martinique","MQ"],["Mauritania","MR"],["Mauritius","MU"],["Mayotte","YT"],["Mexico","MX"],["Micronesia,FederatedStatesof","FM"],["Moldova","MD"],["Monaco","MC"],["Mongolia","MN"],["Montenegro","ME"],["Montserrat","MS"],["Morocco","MA"],["Mozambique","MZ"],["Myanmar","MM"],["Namibia","NA"],["Nauru","NR"],["Nepal","NP"],["Netherlands","NL"],["NetherlandsAntilles","AN"],["NewCaledonia","NC"],["NewZealand","NZ"],["Nicaragua","NI"],["Niger","NE"],["Nigeria","NG"],["Niue","NU"],["NorfolkIsland","NF"],["NorthernMarianaIslands","MP"],["Norway","NO"],["Oman","OM"],["Pakistan","PK"],["Palau","PW"],["PalestinianTerritory,Occupied","PS"],["Panama","PA"],["PapuaNewGuinea","PG"],["Paraguay","PY"],["Peru","PE"],["Philippines","PH"],["Pitcairn","PN"],["Poland","PL"],["Portugal","PT"],["PuertoRico","PR"],["Qatar","QA"],["Romania","RO"],["RussianFederation","RU"],["Rwanda","RW"],["Réunion","RE"],["SaintHelena","SH"],["SaintKittsandNevis","KN"],["SaintLucia","LC"],["SaintPierreandMiquelon","PM"],["SaintVincentandGrenadines","VC"],["Saint-Barthélemy","BL"],["Saint-Martin(Frenchpart)","MF"],["Samoa","WS"],["SanMarino","SM"],["SaoTomeandPrincipe","ST"],["SaudiArabia","SA"],["Senegal","SN"],["Serbia","RS"],["Seychelles","SC"],["SierraLeone","SL"],["Singapore","SG"],["Slovakia","SK"],["Slovenia","SI"],["SolomonIslands","SB"],["Somalia","SO"],["SouthAfrica","ZA"],["SouthGeorgiaandtheSouthSandwichIslands","GS"],["SouthSudan","SS"],["Spain","ES"],["SriLanka","LK"],["Sudan","SD"],["Suriname","SR"],["SvalbardandJanMayenIslands","SJ"],["Swaziland","SZ"],["Sweden","SE"],["Switzerland","CH"],["Syria","SY"],["Taiwan","TW"],["Tajikistan","TJ"],["Tanzania,UnitedRepublicof","TZ"],["Thailand","TH"],["Timor-Leste","TL"],["Togo","TG"],["Tokelau","TK"],["Tonga","TO"],["TrinidadandTobago","TT"],["Tunisia","TN"],["Turkey","TR"],["Turkmenistan","TM"],["TurksandCaicosIslands","TC"],["Tuvalu","TV"],["Uganda","UG"],["Ukraine","UA"],["UnitedArabEmirates","AE"],["UnitedKingdom","GB"],["UnitedStatesMinorOutlyingIslands","UM"],["UnitedStatesofAmerica","US"],["Uruguay","UY"],["Uzbekistan","UZ"],["Vanuatu","VU"],["Venezuela(BolivarianRepublicof)","VE"],["VietNam","VN"],["VirginIslands,US","VI"],["WallisandFutunaIslands","WF"],["WesternSahara","EH"],["Yemen","YE"],["Zambia","ZM"],["Zimbabwe","ZW"]];
...
mapPays.scrollWheelZoom.disable();
/*
...
function getDataPays(Reg, code){
	Reg.onmouseout = function(){
		hideTooltip();
		//Reg.style.fill = getColor(Reg.Temperature);
		Reg.style.opacity = 0.8;
	}
	d3.json("http://api.openweathermap.org/data/2.5/weather?q="+jQuery(Reg).attr('title') + "," + code + "&APPID=bf920662e14bbed958faa4f372a4d167", function(error, meteo) {
		...
		if(Reg.temp !== undefined)
			text = text +'<br /> Meteo : ' + Reg.temp;
		if(Reg.Temperature !== undefined)
			text = text +'<br /> Temperature moyenne : '+ Reg.Temperature;
		if(Reg.Temp_min !== undefined)
			text = text +'<br /> Temperature minimale : ' + Reg.Temp_min;
		if(Reg.Temp_max !== undefined)
			text = text +'<br /> Temperature maximale : ' + Reg.Temp_max;
		...
		if(Reg.Humidity !== undefined)
			text = text +'<br /> Humidite : ' + Reg.Humidity + "%";	
		Reg.text = text;
		Reg.style.fill = getColor(Reg.Temperature);
	});
	...
	Reg.onmouseover = function(){
		...
		//Reg.style.fill = getColor(Reg.Temperature+30);
		Reg.style.opacity = 1;
	}
}

function getCodePays(Reg){
	for (var i = 0; i < listCodePaysMondeAng.length; i++) {
		var nomP = listCodePaysMondeAng[i][0].toLowerCase();
		if( Reg.indexOf(nomP) > -1){
			return listCodePaysMondeAng[i][1];
		}
	};
	return null;
}		
...
function changementSelect(sel){
	d3.xml("./countries/maps/"+sel.value+"High ().svg", function(error, documentFragment) {
		...
		var g = documentFragment.getElementsByTagName("g")[0];
		
		g.id="coordG";

		var codeP = getCodePays(sel.value);
		for (Reg of pathList){
			getDataPays(Reg, codeP);
		}
		...
		var moveRight = centerX - centerPoint.x;
		var moveTop = centerY - centerPoint.y ;
		svgNode.style.transform = "translate(-"+moveRight+"px,"+0+"px)"; 
		svgNode.style.transform = "translate("+0+"px,"+moveTop+"px)"; 
...
LegendTemperature.onAdd = function (mapPays) {
...
LegendTemperature.addTo(mapPays);

// Set du mouseover et out
function onEachFeaturePays(feature, layer) {
	layer.on({
		mouseover: highlightFeaturePays,
		mouseout: resetHighlightPays,
	});
}

// Affiche les informations du pays
function highlightFeaturePays(e) {
	var layer = e.target;
    layer.setStyle({
        weight: 1,
	...
	infoPays.update(e.target.feature.properties.Text, layer.feature.properties.Color);
}

// Efface les informations du pays
function resetHighlightPays(e) {
	info.update("");
	var layer = e.target;
    layer.setStyle({
        opacity: 1,
